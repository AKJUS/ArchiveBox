...
````{py:attribute} SQLITE_TIMEOUT
:canonical: archivebox.config.common.DatabaseConfig.SQLITE_TIMEOUT
:type: float
:value: >
   'Field(...)'

```{autodoc2-docstring} archivebox.config.common.DatabaseConfig.SQLITE_TIMEOUT
```
...
````{py:attribute} ENABLED_PLUGINS
:canonical: archivebox.config.common.ArchivingConfig.ENABLED_PLUGINS
:type: str
:value: >
   'Field(...)'

```{autodoc2-docstring} archivebox.config.common.ArchivingConfig.ENABLED_PLUGINS
```
